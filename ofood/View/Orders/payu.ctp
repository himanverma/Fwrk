  ...
  <script>
    ...
    <form action="<?php echo $action; ?>" method="post" name="payuForm">
      ...
      <table>
        ...
        <tr>
          <td>Success URI: </td>
          <td colspan="3"><input name="surl" value="http://uneekarts.com/office/ofood/orders/payu/1" size="64" /></td>
        </tr>
        <tr>
          <td>Failure URI: </td>
          <td colspan="3"><input name="furl" value="http://uneekarts.com/office/ofood/orders/payu/1" size="64" /></td>
        </tr>
        ...
        <tr>
          ...
          <td>Cancel URI: </td>
          <td><input name="curl" value="http://uneekarts.com/office/ofood/orders/payu/1" /></td>
        </tr>
        <tr>
          <td>Address1: </td>
